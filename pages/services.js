      ...
      <main className="section">
        <div className="container">
          ...
          <div className="grid grid-3">
            ...
            <div className="card"><h3>Timeline Management</h3><p className="small">We coordinate key dates (auction, payoff requests, buyer docs) to keep you protected.</p></div>
            ...
            <div className="card"><h3>Nationwide Network</h3><p className="small">Licensed partners and local expertise across the U.S. for fast, compliant outcomes.</p></div>
          </div>
        </div>
      </main>
      <Footer />
